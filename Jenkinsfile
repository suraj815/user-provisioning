                ...
                script { 
                    properties([
                        parameters([
                            ...
                            validatingString(defaultValue: '', description: 'Enter user first name. It should be from 1 upto 50 characters long', failedValidationMessage: 'First Name is not valid. It should be upto 50 characters long', name: 'First Name', regex: '^.{1,50}$'),
                            validatingString(defaultValue: '', description: 'Enter user last name. It should be from 1 upto 50 characters long ', failedValidationMessage: 'Please enter last name', name: 'Last Name', regex: '^.{1,50}$'),
